...
config. BalloonImgPath		= base_url+"/tip_balloon/" // Path to images (border, corners, stem), in quotes. Path must be relative to your HTML file.

// Sizes of balloon images

config. BalloonEdgeSize		= 6		// Integer - sidelength of quadratic corner images

config. BalloonStemWidth	= 10	// Integer
...

{
	...
	tt_sContent = '<table border="0" cellpadding="0" cellspacing="0" style="max-width:300px;padding:0;margin:0;left:0;top:0;"><tr>'
		...
		+ '<div style="position:relative;z-index:0;top:0;' + sCss0 + 'max-width:300px;height:' + tt_aV[BALLOONEDGESIZE] + 'px;background-image:url(' + aImg[2].src + ');">'
