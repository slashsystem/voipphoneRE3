...
jQuery(document).ready(function($) {
   ...
   // Flyout
	jQuery('.info').on( "mouseover", function() {
	...
	jQuery(".table-right").on( "mouseover", function() {
			 var currentTdId = jQuery(this).attr('id');
			if(currentTdId !='13tdlast' && currentTdId !='14tdlast'){	
	...
	jQuery(".table-right-over").on( "mouseout", function() {
...
// Display More Information in Information Section
