      ...
      // no changes - return nothing      
				...
				<button type="button" class="btn last"><i class="icon-step-forward"></i></button>
				 ...
				 <tr style="background-color:#FFF; border-bottom:#CCCCCC 1px solid; border-right: 1px solid #CCCCCC;">
				  ...
				  <td class="table-left-ohne withdatatablecss" style="margin-left:45px !important;"><input type="checkbox" class="odsentchk" name="a<?php echo $res['Odsentry']['id']; ?>" value="<?php echo $res['Odsentry']['id']; ?>" id="chk<?php echo $res['Odsentry']['id']; ?>" style="margin-left:25px !important;" /></td>
