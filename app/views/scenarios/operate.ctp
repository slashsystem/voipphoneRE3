...
<div class="modalPopLite-child" id="popup-wrapper2">
		...
		<?php echo $html->link(__("Ok", true), 'javascript:void(null)', array('onmouseover'=>'javascript:hoverButtonLeft(this);','onmouseout'=>'javascript:outButtonLeft(this);','onclick'=>'javascript:deletesource('.$scenarioDetails[0]['Scenario']['id'].')', 'id' => 'request_validation','class'=>'clicker2')); ?>
		</div>
   ...
   # if (($scenarioDetails[0]['Scenario']['status'] == 4) || ($scenarioDetails[0]['Scenario']['status'] == 5) || ($scenarioDetails[0]['Scenario']['status'] == 6) || ($scenarioDetails[0]['Scenario']['status'] == 7)) {
    ...
    ?>
            <div style="display:block"> 
               <h4> <?php echo __('executionSchedules'); ?> 
...
<div>
 ...
 <input type="hidden" name="ExecutionUID" id="ExecutionUID" class="exid" value="">
            ...
            <!--  -->
            <div style="display:block">					
                <h4 style="display:block;float:left;width: 100%;"><?php echo __('Scenario History'); ?> <a class="maintopRelatedContentButton" id="maintopContentButton" onclick="return toggleShowHistory();" href="javascript:void(0)" style="float:right;">
