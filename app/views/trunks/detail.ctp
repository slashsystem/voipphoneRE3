	...
	<br>
	   ...
	   ?>
		...
		<table id="example" class="phonekey dataTable">
				...
				<th class="table-column <?php if(in_array('sort:function',$filter_sort) && in_array('direction:asc',$filter_sort)) echo  'sortlink_asc';elseif((in_array('sort:function',$filter_sort) && in_array('direction:desc',$filter_sort))) echo 'sortlink_desc';else echo 'sortlink';?> "style="width:102px;text-align: left;"><?php echo __("name",true); ?></th>

				<th class="table-column" "style="width:102px;text-align: left;"><?php echo __("channel",true); ?></th>
				<th class="table-column" "style="width:102px;text-align: left;"><?php echo __("gate_type",true); ?></th>
				<th class="table-column" "style="width:102px;text-align: left;"><?php echo __("pbx_type",true); ?></th>
				<th class="table-column" "style="width:102px;text-align: left;"><?php echo __("redundancy",true); ?></th>
				<th class="table-column" "style="width:102px;text-align: left;"><?php echo __("sbc",true); ?></th>
				<th class="table-column" "style="width:102px;text-align: left;"><?php echo __("call_scenario",true); ?></th>
				 ...
				 <tbody>
				   <?php
			        ...
			        <tr onmouseover="hoverRow(this,true);" onmouseout="hoverRow(this,false); ">
					  ...
					  <td> <?php echo $trunk['Trunk']['id'];?> </td>
					  <td> <?php echo $trunk['Trunk']['location_id'];?> </td>
					  <td> <?php echo $trunk['Trunk']['name'];?> </td>
					  <td> <?php echo $trunk['Trunk']['channel'];?> </td>
					  <td> <?php echo $trunk['Trunk']['gate_type'];?> </td>
					  <td> <?php echo $trunk['Trunk']['pbx_type'];?> </td>
					  <td> <?php echo $trunk['Trunk']['redundancy'];?> </td>
					  <td> <?php echo $trunk['Trunk']['sbc'];?> </td>
