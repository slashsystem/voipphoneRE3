	...
	<br>
		...
		<!--CBM END HERE -->
	        		<?php
		        		...
		        		<!-- <td><?php echo $html->link($customer['Customer']['name'],  array('controller'=> 'customers', 'action'=>'edit', 'customer_id:' . $customer['Customer']['id'])); ?></td> -->
				...
				<?php } ?>				
                       ...
                       ?>
                         <ul>
                           <li class="dial" ><?php echo $html->link( __("customerHome", true), array('controller'=> 'customers', 'action'=>'edit', 'customer_id:'.$customer['Customer']['id'])); ?></li>
						  <li class="dial" ><?php echo $html->link( __("Edit Customer", true), array('controller'=> 'customers', 'action'=>'customeredit', 'customer_id:'.$customer['Customer']['id']), array('class' => " fancybox fancybox.ajax")); ?></li>
                           ...
                           <?php } ?>
                           <?php if($mCounts[$customer['Customer']['id']]['groupcount'] > 0){ ?>
                           <li class="last handset" ><?php echo $html->link(__("View Group List", true), array('controller'=> 'groups', 'action'=>'index/customer_id:'. $customer['Customer']['id'])); ?></li>
                           <?php } ?>
                           <li class="dial" ><?php echo $html->link( __("View Location List", true), array('controller'=> 'locations', 'action'=>'index', $customer['Customer']['id'])); ?></li>
                           <?php if($mCounts[$customer['Customer']['id']]['mediatrixcount'] > 0){ ?>
                           <li class="last handset" ><?php echo $html->link(__("View Mediatrix List", true), array('controller'=> 'mediatrixes', 'action'=>'index/customer_id:' . $customer['Customer']['id'])); ?></li>
                         	<?php } ?>
                         	<?php if($mCounts[$customer['Customer']['id']]['onDemand'] > 0){ ?>
                         	<li class="dial" ><?php echo $html->link( __("View ODS List", true), array('controller'=> 'scenarios', 'action'=>'index', 'customer_id:'.$customer['Customer']['id'])); ?></li>
                           <?php } ?>
                           <?php if($mCounts[$customer['Customer']['id']]['trunkcount'] > 0){ ?>
                         	<li class="dial" ><?php echo $html->link( __("View Trunk List", true), array('controller'=> 'trunks', 'action'=>'index', $customer['Customer']['id'])); ?></li>
                           <?php } ?>
                         </ul>
                      </div>
                     </div>
