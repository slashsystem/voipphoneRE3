...
<div class="block top">
	<br>
	    <?php echo $form->create('Group',array('action'=>'add_group','id'=>'add_group','type'=>'POST')); ?>				
		...
		<div class="form-box">
			...
			<div class="form-right"><?php echo	$form->submit('submit', array('label' => false,'value'=>'submit','style'=>'width:100px;height:30px;float:right'));	?></div>
		</div>
