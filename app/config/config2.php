...
#-----------------------------------------------------------------#
	...
	if($type=='local'){
		...
		$config['base_path']='/var/www/html/voipphoneRE3/';
		 $config['gate_url']='http://localhost/voipgate/';
...
//	$config['NCOS-LANGUAGE']	=	array('en'=>'48','fr'=>'16','ge'=>'0','IT'=>'32');
	...
	$config['stationStatus']              =       array('1'=>'Active', '2'=>'Imported', '3'=>'Discovered', '4'=>'test','5'=>'InWork','6'=>'Added','7'=>'Exception' );
    $config['featureStatus']              =       array('1'=>'Active', '2'=>'Imported', '3'=>'Discovered', '4'=>'InWork', '5'=>'Moved','6'=>'Added', '7'=>'Deleted', '8'=>'Replaced');
